...
public class Registo {
        ...
        if(cadastro!=null){//para gravar os dados do paciente na primeira vez que for registar-se
             ...
             try{
                 ...
                 //caso o ficheiro nao exista este trecho de codigo cria o ficheiro e grava a informacao nele
                     ...
                     try (FileWriter gravar = new FileWriter("ListaCidadao.txt")) {
    ...
    public static void registar(){
        ...
        do{
            ...
            switch(opcao){
                case 1: 
                    Registo.gravarFicheiro(cadastro,null,"ListaCidadao.txt");
                    stop=0;
                    break;
    ...
    public static void imprimeLista(){
        ...
        do{
            ...
            switch(opcao){//para escolher de que Ficheiro quer imprimir a lista
                case 1:
                    print.lerFicheiro("ListaCidadao.txt");
                    break;
                case 2:
                    print.lerFicheiro("ListaCidadaoFinal.txt");
                    break;
                case 3:
                    Menu voltar=new Menu();
                    stop=0;
    ...
    public void lerFicheiro(String caminho){
     ...
     public static void pesquisa(){
        ...
        int stop=0,opcao;
         do{//Para escolher em que fivheiro procurar dados do paciente
            ...
            if(opcao==1){
                Registo.procura("ListaCidadao.txt");
            }else if(opcao==2){
                Registo.procura("ListaCidadaoFinal.txt");
            }else if(opcao==3){
                Menu voltar = new Menu();
                stop=0;
                voltar.menu();
     ...
     public static void atualizarDados(){
        ...
        int lineNumb=0,i=0;
        try{//os comando estao entre o bloco try..catch para lhe dar com possiveis erros
           File ler = new File("ListaCidadao.txt");
                 Scanner leitor = new Scanner(ler);
                 System.out.println("Cidadao Procurado \n");
            ...
            try{
                ...
                switch(opcao){
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        Registo.gravarFicheiro(null,paciente,"ListaCidadaoFinal.txt");
                        break;
                    case 8:
                        stop=0;
                        voltar.menu();
